...
while i < n and not(jegyek[i] == 1):
    i += 1
if i < n:
    print("F1: van amibul bukott diak vagyok en")
else:
    print("NA JÓLVAN MOSTMÁÁÁÁÁÁÁÁÁR ENNYI ELÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉG")
